...
public interface IPicture {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(PictureViewAttach.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(PictureViewAttach.OnPhotoTapListener listener);

    /**
     * Returns a listener to be invoked when the Photo displayed by this View is tapped with a
     * single tap.
     *
     * @return PictureViewAttach.OnPhotoTapListener currently set, may be null
     */
    PictureViewAttach.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(PictureViewAttach.OnViewTapListener listener);
     ...
     *
     * @return PictureViewAttach.OnViewTapListener currently set, may be null
     */
    PictureViewAttach.OnViewTapListener getOnViewTapListener();
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (PictureViewAttach.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of IPicture (eg. PictureViewAttach), can be used to provide better
     * integration
     *
     * @return IPicture implementation instance if available, null if not
     */
    IPicture getIPictureImplementation();

    /**
     * Sets custom double tap listener, to intercept default given functions. To reset behavior to
     * default, you can just pass in "null" or public field of PictureViewAttach.defaultOnDoubleTapListener
     *
